...
import "jQuery"; // too be able to do this enhance the systemJS config object by map key is import name and value is path
...
$('#app').mouseenter(() => { $('#app').css({"background-color" : "yellow"})})